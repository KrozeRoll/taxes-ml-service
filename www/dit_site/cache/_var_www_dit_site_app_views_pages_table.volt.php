...
<nav class="navbar-mobile">
    <div class="container-fluid">
        <ul class="navbar-mobile__list list-unstyled">
            <li>
                <a href="/"><i class="fas fa-desktop"></i>Главная</a>
            </li>
<!--
            <li>
...
<div class="logo">
    ...
    <a href="#">
        ...
        <span style="font-size: 16px;font-weight: 700;text-transform: capitalize; color: rgb(59, 61, 68)">ТОРГОВЫЙ СБОР</span>
    </a>
...
<div class="menu-sidebar__content js-scrollbar1">
    <nav class="navbar-sidebar">
        <ul class="list-unstyled navbar__list">
            ...
            <li>
                <a href="/table">
                    <i class="fas fa-chart-bar"></i>Таблица</a>
            </li>
            <li>
                <a href="/team">
                    <i class="fas fa-users"></i>Наша команда</a>
            </li>
<!--
            <li>
                <a href="table.html">
                ...
                <div class="header-button">
                    ...
                    <div class="account-wrap">
                        <div class="account-item clearfix js-item-menu">
                            <div class="content">
                                <a class="js-acc-btn" href="#"><?= $user->login ?></a>
                            </div>
